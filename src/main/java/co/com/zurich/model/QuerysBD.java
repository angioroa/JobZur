...
//						INSERCION TABLA zr_radicacion
						...
						preparedStatement.setInt(19, 1); // formulario_repetido
...
//							,,,,,,,,40,41,45,51,54 55 56 57  64 93 94 95 96 97 98 106 110      
							...
							preparedStatement.setInt(29, Integer.parseInt(separacionDatosInsert[81])); // celular
							...
							preparedStatement.setInt(63, Integer.parseInt(separacionDatosInsert[115])); // reclamacion_resultado    x
							preparedStatement.setInt(64, Integer.parseInt(separacionDatosInsert[116])); // reclamacion_anio_2      x
							...
							preparedStatement.setInt(67, Integer.parseInt(separacionDatosInsert[119])); // reclamacion_valor_2        x      
